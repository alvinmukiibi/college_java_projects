...
<html>
    ...
    <body>
        ...
        <form id="signup-form" method="post" action="/Mobile/index.jsp">
    ...
    <sql:setDataSource 
        ...
        user="root" password=""
        />
    <sql:query dataSource="${dbcon}" var="rs">select * from user where username="<%=username%>" and password="<%=password%>" and status="admin";</sql:query>
    ...
    <c:if test="${count==1}">
        <script type="text/javascript">
            ...
            window.location = '/Mobile/Menu.jsp';
